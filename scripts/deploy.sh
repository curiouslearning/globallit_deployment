...
cat ./scripts/openrecoveryscript.template | sed "s/SDCARD_INT/$SDCARD_INT_ESCAPED/g" | sed "s/LABEL/$LABEL/g" | sed "s/VERSION/$VERSION/g" | sed "s/TUNNEL_PORT/$TUNNEL_PORT/g" > ./scripts/openrecoveryscript
...
adb push ./scripts/openrecoveryscript /cache/recovery
